...
INSERT INTO found_items (item_id, user_id, item_name, category, description, private_details, location_found, storage_location, date_found, image_url, status, returned_at, created_at, updated_at) VALUES
    (1, 2, 'Black JBL earbuds case',            'Electronics', 'Small black charging case for wireless earbuds. Found on a study table near the windows.',       'Case has a deep scratch on the lid. Both earbuds are inside, and the right one has a small chip on the stem.',                 'Library',        'Cabinet A, Shelf 1', '2026-09-08', 'images/samples/earbuds-case.jpg', 'stored',   NULL,                  '2026-09-08 11:40:00', '2026-09-08 11:40:00'),
    (2, 2, 'Blue JanSport backpack',            'Bags',        'Navy blue backpack, medium size, left on the bleachers after PE class.',                          'Contains a green calculus notebook, a folding umbrella, and a Casio watch in the front pocket.',            'Gymnasium',      'Cabinet B, Shelf 2', '2026-09-05', 'images/samples/jansport-backpack.jpg', 'stored',   NULL,                  '2026-09-05 16:05:00', '2026-09-05 16:05:00'),
    (3, 2, 'Mapua student ID card',             'IDs & Cards', 'Student ID card in a clear plastic holder with a red lanyard. Turned in by cafeteria staff.',      'Name on card: Jose Dela Cruz. Student number ends in 0266. Lanyard has a small keychain bear.',             'Cafeteria',      'Drawer 1 (IDs)',     '2026-09-10', 'images/samples/student-id.jpg', 'stored',   NULL,                  '2026-09-10 13:15:00', '2026-09-11 09:00:00'),
    (4, 2, 'Casio fx-991 scientific calculator','Electronics', 'Grey/black Casio scientific calculator with slide cover. Left in a lecture room.',                'Initials "K.S." written in marker on the back of the slide cover. Battery cover is cracked.',               'North Building', 'Cabinet A, Shelf 3', '2026-09-03', 'images/samples/casio-calculator.jpg', 'stored',   NULL,                  '2026-09-03 10:20:00', '2026-09-03 10:20:00'),
    (5, 2, 'Silver keychain with 3 keys',       'Keys',        'Keychain with three keys found near the motorcycle parking area.',                               'Has a red bottle-opener tag and one key is a small padlock key.',                                          'Parking Area',   'Drawer 2 (Keys)',    '2026-09-11', 'images/samples/keychain.jpg', 'stored',   NULL,                  '2026-09-11 08:50:00', '2026-09-11 08:50:00'),
    (6, 2, 'Grey hoodie',                       'Clothing',    'Plain grey pullover hoodie, size medium.',                                                        'Name tag inside collar: "B. Lim". Small bleach stain on the left sleeve.',                                 'Student Lounge', 'Cabinet C, Shelf 1', '2026-08-28', 'images/samples/grey-hoodie.jpg', 'returned', '2026-09-02 15:30:00', '2026-08-28 17:10:00', '2026-09-02 15:30:00'),
    (7, 2, 'Black folding umbrella',            'Accessories', 'Compact black umbrella, unbranded.',                                                              'Handle has a piece of yellow tape wrapped around it.',                                                     'Admin Building', 'Bin 4 (Misc)',       '2026-07-14', 'images/samples/umbrella.jpg', 'disposed', NULL,                  '2026-07-14 09:00:00', '2026-08-30 12:00:00');
...
INSERT INTO lost_reports (report_id, user_id, item_name, category, description, location_lost, date_lost, image_url, status, matched_item_id, created_at, updated_at) VALUES
    (1, 3, 'JBL wireless earbuds (black)',  'Electronics',   'JBL Tune 230 earbuds in a black case. The case lid has a scratch and both earbuds were inside when I lost it.', 'Library',        '2026-09-07', 'images/samples/earbuds-case.jpg', 'open',    NULL, '2026-09-07 18:25:00', '2026-09-07 18:25:00'),
    (2, 3, 'Student ID with red lanyard',   'IDs & Cards',   'My Mapua ID in a clear holder. The lanyard has a tiny bear keychain.',                                                                      'Cafeteria',      '2026-09-10', 'images/samples/student-id.jpg', 'matched', 3,    '2026-09-10 14:00:00', '2026-09-11 09:00:00'),
    ...
    (5, 5, 'Grey hoodie',                   'Clothing',      'Grey pullover hoodie, medium. Has a name tag inside the collar.',                                                                          'Student Lounge', '2026-08-27', 'images/samples/grey-hoodie.jpg', 'closed',  6,    '2026-08-27 20:00:00', '2026-09-02 15:30:00');
...
INSERT INTO claims (claim_id, item_id, user_id, report_id, proof_description, status, date_claimed, reviewed_by, review_note, reviewed_at, created_at, updated_at) VALUES
    (1, 1, 3, 1,    'These are JBL Tune 230 earbuds. The case has a scratch on the lid, both earbuds should be inside, and the right earbud has a small chip on the stem.', 'pending',  '2026-09-09', NULL, NULL,                                                                                                          NULL,                  '2026-09-09 08:15:00', '2026-09-09 08:15:00'),
    (2, 3, 3, 2,    'It is my student ID. My student number ends in 0266 and the lanyard has a small bear keychain.',                                                                           'approved', '2026-09-10', 2,    'Details match. Please bring a valid ID to the Lost & Found office (Admin Bldg, Rm 104) to claim.',            '2026-09-11 09:00:00', '2026-09-10 15:30:00', '2026-09-11 09:00:00'),
